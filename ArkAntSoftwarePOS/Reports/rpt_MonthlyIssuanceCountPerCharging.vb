...
Public Class rpt_MonthlyIssuanceCountPerCharging
    ...
    Private Sub displayHeader()
        ...
        Dim TOTALLBL As New DataDynamics.ActiveReports.Label() _
                    With {.Size = TextBox14.Size, .Text = "TOTAL", .Style = FontStyle.Regular, .Font = Label1.Font, .Alignment = TextAlignment.Center, .VerticalAlignment = VerticalTextAlignment.Middle, .Location = New PointF(0, TextBox14.Location.Y)}
        ...
        If MeData.Rows.Count > 0 Then
            ...
            Dim EMPreg As New DataDynamics.ActiveReports.Label() _
                    With {.Size = txtSIHeader.Size, .Text = "EMP-REG", .Style = FontStyle.Bold, .Font = Label1.Font, .Alignment = TextAlignment.Center, .VerticalAlignment = VerticalTextAlignment.Middle, .Location = New PointF(0 + xLoc1, Label1.Location.Y)}
            ...
            Dim EMPjo As New DataDynamics.ActiveReports.Label() _
                    With {.Size = txtSIHeader.Size, .Text = "EMP-JO", .Style = FontStyle.Bold, .Font = Label1.Font, .Alignment = TextAlignment.Center, .VerticalAlignment = VerticalTextAlignment.Middle, .Location = New PointF(0 + xLoc1, Label1.Location.Y)}
            ...
            Dim TOTALHeader As New DataDynamics.ActiveReports.Label() _
                    With {.Size = txtSIHeader.Size, .Text = "TOTAL", .Style = FontStyle.Bold, .Font = Label1.Font, .Alignment = TextAlignment.Center, .VerticalAlignment = VerticalTextAlignment.Middle, .Location = New PointF(0 + xLoc1, Label1.Location.Y)}
            ...
            '        With {.Size = txtSIHeader.Size, .Text = "UNFILLED", .Style = FontStyle.Bold, .Font = Label1.Font, .Alignment = TextAlignment.Center, .VerticalAlignment = VerticalTextAlignment.Middle, .Location = New PointF(0 + xLoc1, Label1.Location.Y)}
            ...
            If TypeOf iControl Is DataDynamics.ActiveReports.Label Then
                ...
                If Not tag Is Nothing Then
                    ...
                    If Not tag.Contains("detail_") Then
                        ...
                        Dim SQLEX As String = "SELECT COUNT(item_invcode) 'count' FROM daily_sales_master"
                        ...
                        If MeData.Rows.Count > 0 Then
                            Try
                                ...
                                CType(iControl, DataDynamics.ActiveReports.Label).Text = Format(count, "#,##0")
                                TOTAL += count
                    ...
                    ElseIf tag.Contains("detail_") Then
                        If tag = "detail_reg" Then
                            Dim SQLREG As String = "SELECT COUNT(item_invcode) 'count'"
                            SQLREG += " FROM daily_sales_master"
                            SQLREG += " INNER JOIN daily_sales_detail"
                            SQLREG += " ON (`daily_sales_master`.`SysPK` = `daily_sales_detail`.`sales_sys`)"
                        ...
                        ElseIf tag = "detail_jo" Then
                            Dim SQLJO As String = "SELECT COUNT(item_invcode) 'count'"
                            SQLJO += " FROM daily_sales_master"
                            SQLJO += " INNER JOIN daily_sales_detail"
                            SQLJO += " ON (`daily_sales_master`.`SysPK` = `daily_sales_detail`.`sales_sys`)"
                        ...
                        ElseIf tag = "detail_total" Then
                            CType(iControl, DataDynamics.ActiveReports.Label).Text = Format(TOTAL, "#,##0")
                            TOTAL_TOTAL += TOTAL
                        End If
                    End If
                End If
            ...
            If TypeOf iControl Is DataDynamics.ActiveReports.Label Then
                ...
                If Not tag Is Nothing Then
                    ...
                    ElseIf tag.Contains("subtotal_reg") Then
                        CType(iControl, DataDynamics.ActiveReports.Label).Text = Format(TOTAL_REG, "#,##0")
                    ElseIf tag.Contains("subtotal_jo") Then
                        CType(iControl, DataDynamics.ActiveReports.Label).Text = Format(TOTAL_JO, "#,##0")
