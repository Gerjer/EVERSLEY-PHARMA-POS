Public Class fmaSuppliesCustodianListForm
    ...
    Private WithEvents SETUPFORM As fmaSuppliesCustodianSetupForm
...
#Region "Viewers Info"
    Private Sub Attach()
        ...
        Dim SQL As String = "SELECT SysPK,a_code,a_name,sup_address, contact_num, email_add "
        SQL += " FROM " & TABLENAME
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("a_name").DataColumn.Caption = "SUPPLIER NAME"
                ...
                .DisplayColumns("sup_address").Width = 250
                ...
                .DisplayColumns("contact_num").Width = 250
                .DisplayColumns("contact_num").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("contact_num").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near

                .DisplayColumns("email_add").DataColumn.Caption = "EMAIL"
...
#End Region
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If SETUPFORM Is Nothing Then
            SETUPFORM = New fmaSuppliesCustodianSetupForm
