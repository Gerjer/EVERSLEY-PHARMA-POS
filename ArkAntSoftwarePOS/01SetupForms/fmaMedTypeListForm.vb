...
Public Class fmaMedTypeListForm
    ...
    Private TABLENAME As String = "medtype"

    Private WithEvents SETUPFORM As fmaMedTypeSetupForm
...
#Region "Viewers Info"
    Private Sub Attach()
        ...
        '
        Dim SQL As String = "SELECT SysPK_Item,Item_Code,Item_Display,"
        SQL += " IFNULL(medtype.class_based_id,0)'class_based_id',IFNULL(class_based.`name`,'')'name',IFNULL(medtype.discription,'')'description'"
        SQL += " FROM " & TABLENAME
        SQL += " LEFT JOIN class_based ON medtype.class_based_id = class_based.id"
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("Item_Code").Width = 200
                ...
                .DisplayColumns("Item_Display").DataColumn.Caption = "MEDICINE TYPE"
                .DisplayColumns("Item_Display").Width = 300
                ...
                .DisplayColumns("class_based_id").Visible = False
                .DisplayColumns("class_based_id").AutoSize()

                .DisplayColumns("name").DataColumn.Caption = "CLASSIFICATION BASED"
...
#End Region
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If SETUPFORM Is Nothing Then
            SETUPFORM = New fmaMedTypeSetupForm
    ...
    Private Sub deleteSelectedItem()
        ...
        Try
            ITEMSYSPK = GridView1.GetFocusedRowCellValue("SysPK_Item").ToString 'tdbViewer.Columns.Item(0).Value
        Catch ex As Exception
