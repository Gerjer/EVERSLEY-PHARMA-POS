Public Class fmaItemListForm
    ...
    Private TABLENAME As String = "product_item"

    Private WithEvents SETUPFORM As fmaItemSetupForm
...
#Region "Viewers Info"
    Private Sub Attach()
        ...
        Dim SQL As String = "SELECT SysPK_Item,Item_Code,Item_Display,Item_Description, brand_name,medtype "
        SQL += " FROM " & TABLENAME
        SQL += " ORDER BY Item_Display "
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("Item_Display").DataColumn.Caption = "ITEM NAME"
                .DisplayColumns("Item_Display").Width = 250
                .DisplayColumns("Item_Display").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("Item_Display").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near

                .DisplayColumns("Item_Description").DataColumn.Caption = "DESCRIPTION"
                .DisplayColumns("Item_Description").Width = 250
                .DisplayColumns("Item_Description").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("Item_Description").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near

                .DisplayColumns("brand_name").DataColumn.Caption = "MANUFACTURER"
                .DisplayColumns("brand_name").Width = 200
                ...
                .DisplayColumns("medtype").DataColumn.Caption = "TYPE"
                .DisplayColumns("medtype").Width = 100
                .DisplayColumns("medtype").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("medtype").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near
...
#End Region
    ...
    Private Sub searchFilterText()
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("Item_Description").DataColumn.Caption = "DESCRIPTION"
                .DisplayColumns("Item_Description").Width = 350
                .DisplayColumns("Item_Description").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("Item_Description").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If SETUPFORM Is Nothing Then
            SETUPFORM = New fmaItemSetupForm
