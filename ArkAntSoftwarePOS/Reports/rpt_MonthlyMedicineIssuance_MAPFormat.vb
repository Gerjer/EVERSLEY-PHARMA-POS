...
Public Class rpt_MonthlyMedicineIssuance_MAPFormat
    ...
    Private Sub GroupHeader3_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GroupHeader3.Format
        ...
        Dim SQLEX As String = "SELECT sales_sys, daily_sales_master.patient_name, item_invcode, item_descr,consignee,item_qty,inventory_master.item_price,item_disc,SUM(daily_sales_detail.item_qty * inventory_master.item_buyprice) AS 'Itr_amount' "
