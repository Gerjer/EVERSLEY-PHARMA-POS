...
Public Class fmaStorageLocationListForm
    ...
    Private TABLENAME As String = "inventory_location"

    Private WithEvents SETUPFORM As fmaStorageLocationSetupForm
...
#Region "Viewers Info"
    Private Sub Attach()
        ...
        Dim SQL As String = "SELECT SysPK,a_code,location_name,Description"
        SQL += " FROM " & TABLENAME
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("location_name").DataColumn.Caption = "STORAGE LOCATION"
                .DisplayColumns("location_name").Width = 300
                .DisplayColumns("location_name").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("location_name").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near
...
#End Region
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If SETUPFORM Is Nothing Then
            SETUPFORM = New fmaStorageLocationSetupForm
