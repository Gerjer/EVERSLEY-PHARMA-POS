...
Public Class fmaWardListForm
    ...
    Private TABLENAME As String = "ward"

    Private WithEvents SETUPFORM As fmaWardSetupForm
...
#Region "Viewers Info"
    Private Sub Attach()
        ...
        Dim SQL As String = "SELECT SysPK,a_code,a_name,description,contact_num "
        SQL += " FROM " & TABLENAME
        SQL += " ORDER BY a_name "
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("contact_num").DataColumn.Caption = "CONCTACT NUMBER"
        ...
        For i As Integer = 0 To view.Columns.Count - 1
            Select Case i
                ...
                Case 3
                    ...
                    view.Columns(i).AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near
                Case 4
                    view.Columns(i).Caption = "CONCTACT NUMBER"
                    view.Columns(i).AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
                    view.Columns(i).AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
                Case Else
...
#End Region
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If SETUPFORM Is Nothing Then
            SETUPFORM = New fmaWardSetupForm
