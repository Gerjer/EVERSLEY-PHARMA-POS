...
Public Class fmaPharmaMasterListForm
    ...
    Private TABLENAME As String = "pharmaceuticals"

    Private WithEvents SETUPFORM As fmaPharmaSetupForm
...
#Region "Viewers Info"
    Private Sub Attach()
        ...
        Dim SQL As String = "SELECT SysPK,a_code,a_name,IF(paymentgroup='0','Private','Government') 'type',address,contactNum,paymentgroup"
        SQL += " FROM " & TABLENAME
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("type").DataColumn.Caption = "PAY GROUP"
                .DisplayColumns("type").Width = 150
                ...
                .DisplayColumns("address").Width = 250
                ...
                .DisplayColumns("contactNum").DataColumn.Caption = "CONTACT NUMBER"
                .DisplayColumns("contactNum").Width = 100
                .DisplayColumns("contactNum").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("contactNum").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near

                .DisplayColumns("paymentgroup").Visible = False
    ...
    Private Sub DesignGridview(gridView1 As GridView)
        ...
        For i As Integer = 0 To view.Columns.Count - 1
            Select Case i
                ...
                Case 3
                    view.Columns(i).Caption = "PAY GROUP"
                    view.Columns(i).AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
                    view.Columns(i).AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
                Case 4
...
#End Region
    ...
    Private Sub searchFilterText()
        ...
        Dim SQL As String = "SELECT SysPK,a_code,a_name,address,contactNum"
        SQL += " FROM " & TABLENAME
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("a_code").DataColumn.Caption = "MEMBER'S ID"
                .DisplayColumns("a_code").Width = 100
                .DisplayColumns("a_code").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("a_code").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near


                .DisplayColumns("a_name").DataColumn.Caption = "MEMBER NAME"
                .DisplayColumns("a_name").Width = 250
                .DisplayColumns("a_name").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("a_name").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If SETUPFORM Is Nothing Then
            SETUPFORM = New fmaPharmaSetupForm
