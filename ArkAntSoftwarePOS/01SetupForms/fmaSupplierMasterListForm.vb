...
Public Class fmaSupplierMasterListForm
    ...
    Private TABLENAME As String = "supplier"

    Private WithEvents SETUPFORM As fmaSupplierSetupForm
...
#Region "Viewers Info"
    Private Sub Attach()
        ...
        Dim SQL As String = "SELECT SysPK,a_code,a_name,sup_address,contact_num,email_add,case when supplier_type = 0 then 'Private' else 'Government' end as 'supplier_type',supplier_type 'supplier_type_id'"
        SQL += " FROM " & TABLENAME
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("a_code").DataColumn.Caption = "ID"
                ...
                .DisplayColumns("a_name").DataColumn.Caption = "COMPANY NAME"
                ...
                .DisplayColumns("sup_address").DataColumn.Caption = "ADDRESS"
                .DisplayColumns("sup_address").Width = 300
                .DisplayColumns("sup_address").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("sup_address").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near

                .DisplayColumns("contact_num").DataColumn.Caption = "CONTACT NUMBER"
                .DisplayColumns("contact_num").Width = 150
                .DisplayColumns("contact_num").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("contact_num").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center

                .DisplayColumns("email_add").DataColumn.Caption = "E-MAIL ADDRESS"
                .DisplayColumns("email_add").Width = 150
                .DisplayColumns("email_add").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("email_add").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near

                .DisplayColumns("supplier_type").DataColumn.Caption = "SUPPLIER TYPE"
                .DisplayColumns("supplier_type").Width = 150
                .DisplayColumns("supplier_type").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("supplier_type").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near

                .DisplayColumns("supplier_type_id").Visible = False
    ...
    Private Sub DesignGridView(gridView1 As GridView)
        ...
        For i As Integer = 0 To view.Columns.Count - 1
            Select Case i
                ...
                Case 2
                    view.Columns(i).Caption = "COMPANY NAME"
                    view.Columns(i).AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
                ...
                Case 3
                    ...
                    view.Columns(i).AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Near
                Case 4
                    view.Columns(i).Caption = "CONTACT NUMBER"
                    view.Columns(i).AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
                    view.Columns(i).AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
                Case 5
                    view.Columns(i).Caption = "E-MAIL ADDRESS"
                    view.Columns(i).AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
                    view.Columns(i).AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
                Case 6
                    view.Columns(i).Caption = "SUPPLIER TYPE"
                    view.Columns(i).AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
                    view.Columns(i).AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
                Case Else
...
#End Region
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If SETUPFORM Is Nothing Then
            SETUPFORM = New fmaSupplierSetupForm
            '        SETUPFORM.supplier = 2
    ...
    Private Sub tdbViewer_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles tdbViewer.MouseUp
        ...
        If e.Button = Windows.Forms.MouseButtons.Left Then
            ...
            supplier = tdbViewer(row, "supplier_type_id")
    ...
    Private Sub GridView1_RowCellClick(sender As Object, e As RowCellClickEventArgs) Handles GridView1.RowCellClick
        If e.Button = Windows.Forms.MouseButtons.Left Then
            ...
            supplier = GridView1.GetFocusedRowCellValue("supplier_type_id").ToString   'tdbViewer(row, "supplier_type_id")
