...
Public Class fmaPatientTypeMasterSetupForm
...
#Region "Classes"
    Private Sub AttachClasses()
        ...
        clsGroup.AttachControl = Me.txtpatient_type
        clsGroup.AttachControl = Me.txtpayment_type
...
#End Region
    ...
    Private Sub txta_name_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txta_name.SelectedIndexChanged
        If txta_name.SelectedIndex = 0 Then
            txtpatient_type.Text = 0
        Else
            txtpatient_type.Text = 1
        End If
    End Sub
End Class