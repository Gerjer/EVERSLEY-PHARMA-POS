Public Class frmSU_Pass
    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        Dim SQL As String = String.Format("SELECT Type_User FROM users WHERE Type_User IN('SUPERUSER','Supervisor') AND Password_User='{0}' AND SysPK_User<>0", Me.txtPassword.Text)
